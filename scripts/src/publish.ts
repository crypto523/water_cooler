...
let proc = Bun.spawnSync([
    "/home/mentalist/suibase/workdirs/testnet/sui-repo/target/debug/sui",
    "move",
    "build",
    "--dump-bytecode-as-base64",
    "--path",
    "/home/mentalist/water_cooler/contracts",
  ]);

    const { modules, dependencies } = JSON.parse(proc.stdout.toString());
